...
Shader "GAP/AlphaBlendedDistortionScroll"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            uniform float4 _MainTexMask_ST;
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR
            {
                ...
                float2 node_2151 = ((node_1914.g * float2(_MainTextUSpeed, _MainTextVSpeed)) + lerp(
                    i.uv0, node_405, _DistortMainTexture));
                ...
                float3 node_2393 = (_MainTex_var.rgb * i.vertexColor.rgb * (_TintColor.rgb * _ColorMultiplier) * 2.0 * (
                    _MainTex_var.a * (_Gradient_var.rgb * pow(_Gradient_var.rgb, _GradientPower)) * _MainTexMask_var.a *
                ...
                fixed4 finalRGBA = fixed4(
                    finalColor, ((i.vertexColor.a * _TintColor.a * _MainTex_var.a * _MainTexMask_var.a) * node_3830));
